...
seeds-own [lifespan nectar-regeneration start-of-bloom active]
flowers-own [flower-seeds flower-block lifespan nectar-regeneration start-of-bloom] ; Added start-of-bloom
...
;The pollen is stored in a list. The species of each flower cooresponds to the index in list like so: [sp1 sp2 sp3 sp4]
...
to make-seeds
  ...
  ask n-of number-of-sp1 patches
    [
    sprout-seeds 1 [
      set color white
      set size 1
